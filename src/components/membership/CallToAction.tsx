    ...
    <div className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl text-sentinel-white font-bold mb-4">
            Join the Security Movement. Be a Sentinel.
          </h2>
          <p className="text-sentinel-white/60 max-w-2xl mx-auto mb-8">
            Take an active role in safeguarding your Web3 experience with the right tools.
          </p>
