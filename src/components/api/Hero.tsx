    ...
    <div className="relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
        <h1 className="text-4xl lg:text-5xl font-bold mb-6">
          <span className="text-sentinel-white">Extend Your Defense Perimeter with</span>{' '}
        ...
        <p className="text-lg text-sentinel-white/70 mb-8 max-w-2xl mx-auto">
          Protect your users from scams and threats across the decentralized web with our powerful API and Browser Extension.
        </p>
