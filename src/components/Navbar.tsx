...
import { Shield, ChevronDown, Activity, Lock, Users, Bell, Code, FileText, Wallet, Brain, Bug, HelpCircle } from 'lucide-react';
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/roadmap', text: 'Roadmap', icon: FileText },
            { href: '/faq', text: 'FAQ & Support', icon: HelpCircle },
    ]
  },
  {
    text: 'Tools',
